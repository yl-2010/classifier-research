/**
 * JWT verification for tokens minted by Vercel GET /api/mac-token.
 * Secret must match Vercel NEXTAUTH_SECRET.
 */
...
export function getAuthConfig() {
  return {
    ...
    issuer: process.env.JWT_ISSUER || "notelms-next",
    audience: process.env.JWT_AUDIENCE || "notelms-mac-api",
  };
}
